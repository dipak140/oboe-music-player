 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_setupAudioStreamNative(
...
Java_com_plausiblesoftware_drumthumper_MusicPlayer_startAudioStreamNative(
 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_teardownAudioStreamNative(JNIEnv* , jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_unloadWavAssetsNative(JNIEnv* env, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_trigger(JNIEnv* env, jobject, jint index) {
 ...
 * Native (JNI) implementation of MusicPlayer.trigger()
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_stopTrigger(JNIEnv* env, jobject, jint index) {
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_getOutputReset(JNIEnv*, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_clearOutputReset(JNIEnv*, jobject) {
 ...
 */
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_restartStream(JNIEnv*, jobject) {
    sDTPlayer.resetAll();
...
JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_setPan(
        JNIEnv *env, jobject thiz, jint index, jfloat pan) {
    sDTPlayer.setPan(index, pan);
}

JNIEXPORT jfloat JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_getPan(
        JNIEnv *env, jobject thiz, jint  index) {
    return sDTPlayer.getPan(index);
}

JNIEXPORT void JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_setGain(
        JNIEnv *env, jobject thiz, jint  index, jfloat gain) {
    sDTPlayer.setGain(index, gain);
}

JNIEXPORT jfloat JNICALL Java_com_plausiblesoftware_drumthumper_MusicPlayer_getGain(
        JNIEnv *env, jobject thiz, jint index) {
